...
# Dario Rodriguez Gonzalez's CV

This repository contains **my professional data**, stored as a [MAC](/CV/MAC.json) (or Manfred Awesomic CV), an open-source, interchangeable, machine-readable format. It's also synchronized with [my profile in Manfred](https://getmanfred.com/profile/dariorodriguez).
<br/>
<br/>

<div align='center'>
  <img src='https://img.shields.io/static/v1?label=CV%20Last%20Sync&message=2025-02-01 17:59 UTC&color=brightgreen&style=for-the-badge'>
